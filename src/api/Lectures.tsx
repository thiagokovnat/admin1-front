import { AddVideoToCourseParams, CreateLectureRequest, Lecture, LectureByCourse, UploadVideoResponse } from "../models/Lectures";
...
export const uploadVideo = async (file: File) => {
    try {
        ...
        const videoUploadResponse = await LearningApi.post<UploadVideoResponse>("/lectures/video", formData, {
            headers: {
...
export const createCourse = (title: string) => {
    try {
        return LearningApi.post("/courses", {title}, {
            headers: {
                Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoyLCJleHAiOjE2OTkzMTIxNjh9.bhwb4DjlWcb96CnNyk1SfinKkxHQGd9HYxl_59ckq-w"
            }
        });
    } catch (error) {
        throw error;
