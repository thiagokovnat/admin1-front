...
export const AllCourses = () => {
    ...
    const lecturesFiltered = useMemo(() => lectures.filter((lecture) => lecture.title.toLowerCase().includes(searchParam.toLowerCase())), [lectures, searchParam])
    ...
    return (
        <Layout>
            <div style={{display: 'flex', gap: 10, flexDirection: "column"}}>
                <Input title="Search" onChange={(e) => setSearchParam(e.target.value)}/>
                {
